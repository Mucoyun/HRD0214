	...
	<section>
		...
		<table id="s_table">
			...
			<%
				int no = 0;
				try{
					String sql = "select a.productCode,a.productName,a.storeCode,b.storeName,a.unitPrice,a.stockQty,(a.unitPrice*a.stockQty) from product0214 a, store0214 b where a.storeCode=b.storeCode order by a.productCode asc";
